...
- [x] 2. Implement database layer and People model

  - [x] 2.1 Create SQLite database connection and initialization

    - Write database connection utilities and schema creation
    - Implement database initialization with People table
    - _Requirements: 1.1, 1.3_

  - [x] 2.2 Implement People data model and CRUD operations
...
- [-] 3. Create People management API endpoints
  ...
  - [x] 3.1 Implement People router with CRUD endpoints
...
- [x] 4. Implement Beach API with business logic

  - [x] 4.1 Create Beach logic service
  ...
  - [x] 4.2 Create Beach API endpoint
...
- [x] 5. Implement static document storage and API

  - [x] 5.1 Create policy documents and static file structure
  ...
  - [x] 5.2 Implement document API endpoint
...
- [x] 6. Set up React frontend foundation

  - [x] 6.1 Initialize React application and project structure
  ...
  - [x] 6.2 Create API service layer
    - Implement API client for backend communication
    - Create service functions for people, beach, and document endpoints
    - Add error handling for network requests
    - _Requirements: 4.3_

- [x] 7. Implement chat interface component

  - [x] 7.1 Create Chat interface component
  ...
  - [x] 7.2 Integrate chat component with main application
...
- [x] 8. Add sample data and final integration

  - [x] 8.1 Create database seeding with sample people data

    - Add sample people records with various staffing statuses
    - Create data seeding script for development setup
    - _Requirements: 1.1, 2.1_

  - [x] 8.2 Configure CORS and finalize backend-frontend integration
...
- [x] 9. Create documentation and setup instructions

  - [x] 9.1 Write README with setup and usage instructions
  ...
  - [x] 9.2 Document extension points for multi-agent integration
...
- [ ] 10. Make sure that the frontend works correctly (Compiles correctly and chat window opens)
- [x] 11. Dockerise the backend and frontend
